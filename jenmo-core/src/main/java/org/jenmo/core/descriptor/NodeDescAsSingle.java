...
/**
 * Package access level class. Implementation of {@link INodeDescAsSingle}.
 * 
 * @author Nicolas Ocquidant
 * @since 1.0
 */
class NodeDescAsSingle implements INodeDescAsSingle {

   @Override
   public AdapterToSingle<Node, Edge> instantiateAdapter(final Node node,
