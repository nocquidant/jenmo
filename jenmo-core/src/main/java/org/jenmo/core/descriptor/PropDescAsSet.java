...
/**
 * Package access level class. Implementation of {@link IPropDescAsSet<T>}.
 * 
 * @author Nicolas Ocquidant
 * @since 1.0
 */
class PropDescAsSet<T> implements IPropDescAsSet<T> {

   private Class<T> clazz;

   public PropDescAsSet(Class<T> clazz) {
      this.clazz = clazz;
   }

   @Override
   public AdapterToSet<T, NodeProperty> instantiateAdapter(final Node node, final Property prop,
